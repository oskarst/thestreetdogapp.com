    ...
    <div className="px-4 py-4 max-w-2xl mx-auto space-y-4">
      ...
      <section className="card-soft p-4 flex items-center gap-4">
        ...
        <div className="min-w-0">
          ...
          {dog.ear_tag_id && (
            <div className="font-mono text-[10.5px] tracking-[0.04em] text-muted-foreground mt-1">
        ...
        <ol className="space-y-3">
          {steps.map((n) => (
            <li key={n} className="flex gap-3">
              <span className="grid place-items-center size-7 shrink-0 rounded-full bg-ink text-background font-mono text-[12px] font-medium">
                {n}
              </span>
