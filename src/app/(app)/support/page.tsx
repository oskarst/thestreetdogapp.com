  ...
  return (
    <div className="px-4 py-4 max-w-2xl mx-auto space-y-4">
      <Link
        href="/dashboard"
        prefetch={false}
        className="inline-flex items-center gap-1.5 font-mono text-[11px] tracking-[0.06em] uppercase text-muted-foreground hover:text-ink transition-colors no-underline"
      >
      ...
      <section className="card-soft p-4 space-y-3">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 rounded-full bg-ink px-4 py-2.5 text-background font-mono text-[12px] font-medium tracking-[0.06em] uppercase hover:brightness-110 transition-all no-underline"
        >
      ...
      <section className="card-soft p-4 space-y-3">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 rounded-full bg-amber-brand px-4 py-2.5 text-amber-soft font-mono text-[12px] font-medium tracking-[0.06em] uppercase hover:brightness-110 transition-all no-underline"
        >
          {t("donateCta")}
        </a>
      </section>
      ...
      <section className="rounded-2xl border border-amber-brand/40 bg-amber-soft p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-medium text-[14px] text-amber-brand leading-tight">
              {t("helpInPlaceTitle")}
            </h3>
            <p className="text-[13px] text-amber-brand/90 leading-snug mt-1">
              {t("helpInPlaceBody")}
            </p>
          </div>
        </div>
